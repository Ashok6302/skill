...
$ret=mysqli_query($con,"insert into students(UserName,Regno,department,password) values('$studentname','$studentregno','$department','$password')");
if($ret)
{
...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    <label for="studentname">Student Department </label>
    <input type="text" class="form-control" id="studentname" name="department" placeholder="Department" required />
  </div>
