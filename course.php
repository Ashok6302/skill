...
$ret=mysqli_query($con,"insert into course(courseCode,courseName,courseUnit,noofSeats,courseamount) values('$coursecode','$coursename','$courseunit','$seatlimit','$courseamount')");
if($ret)
{
...
<div class="form-group">
  ...
  <div class="form-group">
    <label for="seatlimit">Course Amount  </label>
    <input type="text" class="form-control" id="courseamount" name="courseamount" placeholder="amount" required />
  </div>  
...
?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($row['courseUnit']);?></td>
                                             ...
                                             <td><?php echo htmlentities($row['courseamount']);?></td>
