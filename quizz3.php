...
const questions = [
    {
        "question": "Which component is used to execute Python scripts?",
        "answer": [
            { "text": "Python Interpreter", "correct": true},
            { "text": "Python Runtime", "correct": false},
            { "text": "Python Compiler", "correct": false},
            { "text": "Python Debugger", "correct": false}
        ]
    },
    {
        "question": "What is the correct way to start a Python script?",
        "answer": [
            { "text": "? python", "correct": false},
            { "text": "?python", "correct": false},
            { "text": "?py", "correct": false},
            { "text": "?python3", "correct": true}
        ]
    },
    {
        "question": "Which Python function is used to output data to the screen?",
        "answer": [
    ...
    },
    {
        ...
        "answer": [
            { "text": "Prints a value", "correct": false},
            { "text": "Exits the function and returns a value", "correct": true},
            { "text": "Restarts the function", "correct": false},
