            ...
            <div class="w3l-form-info">
                <div class="w3_info">
                    ...
                    <form action="userdetails.php" method="post">
                        ...
                        <div class="input-group">
                            <span><i class="fas fa-user" aria-hidden="true"></i></span>
                            <input type="text" name="Regno" placeholder="Create Registration id" required="">
                        </div>
                        <div class="input-group">
                            <span><i class="fas fa-user" aria-hidden="true"></i></span>
                    ...
                    <p class="account">Already have an account? <a href="index.php">Login Here</a></p>
                </div>
            </div>
            <!-- //main content -->
        </div>
